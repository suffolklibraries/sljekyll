---
title: "Takeover Festival at Ipswich County and Gainsborough Community libraries"
layout: blank
---
...
<article>
    ...
    <header class="ph2 ph3-ns bg-black near-white bb b--light-gray pv3 pv4-l">
        ...
        <div class="custom-max-width">
          ...
          <h1 class="ma0 f5 f4-ns tracked ttl small-caps normal lightest-blue lh-title"><span class="pb1 bb-ns bw3-ns b--lightest-blue-ns">Takeover Festival at Ipswich County and Gainsborough Community libraries</span></h1>

          <div class="flex-ns flex-wrap-ns">

            <div class="w-50-ns pr3-ns mb3">

              <p class="f4 f3-ns">Live music and workshops for and by under-25s on Saturday 9 November. Our art, our voice. <a class="gold" href="/news/youth-takeover-festival/">Find out more &rarr;</a></p>
      ...
      <section class="ph2 ph3-ns bg-light-gray dark-gray pv3 pv4-l">
        ...
        <div class="custom-max-width">
          ...
          {% assign events = site.events | where: "event-category", "takeover-festival" | sort: 'event-start-date' %}
