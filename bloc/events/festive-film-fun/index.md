...
<article>
    ...
    <header class="ph2 ph3-ns bg-black near-white bb b--light-gray pv3 pv4-l">
        ...
        <div class="custom-max-width">
          ...
          <h1 class="ma0 f5 f4-ns tracked ttl small-caps normal lightest-blue lh-title"><span class="pb1 bb-ns bw3-ns b--lightest-blue-ns">Festive Film Fun</span></h1>

          <div class="flex-ns flex-wrap-ns">

            <div class="w-50-ns pr3-ns mb3">

              <p class="f4 f3-ns">Warm and friendly festive film afternoons with sweet and savoury treats at Ipswich County Library.</p>
      ...
      <section class="ph2 ph3-ns bg-light-gray dark-gray pv3 pv4-l">
        ...
        <div class="custom-max-width">
          ...
          {% assign events = site.events | where: "event-category", "festive-film" | sort: 'event-start-date' %}
