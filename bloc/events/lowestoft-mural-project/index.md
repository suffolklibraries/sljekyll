...
<article>
    ...
    <header class="ph2 ph3-ns bg-black near-white bb b--light-gray pv3 pv4-l">
        ...
        <div class="custom-max-width">
          ...
          <h1 class="ma0 f5 f4-ns tracked ttl small-caps normal lightest-blue lh-title"><span class="pb1 bb-ns bw3-ns b--lightest-blue-ns">Lowestoft Mural Project</span></h1>

          <div class="flex-ns flex-wrap-ns">

            <div class="w-50-ns pr3-ns mb3">

              <p class="f4 f3-ns">Help create a personal patchwork of Lowestoft with your ideas, memories and favourite places with artist Kristy Campbell.</p>
      ...
      <section class="ph2 ph3-ns bg-light-gray dark-gray pv3 pv4-l">
        ...
        <div class="custom-max-width">
          ...
          {% assign events = site.events | where: "event-category", "bloc-mural" | sort: 'event-start-date' %}
