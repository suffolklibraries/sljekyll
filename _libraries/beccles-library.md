...
branch-parking: public pay and display car park available with limited free parking spaces
branch-toilet: y
branch-bookdrop: y
branch-refreshments: Hot drinks available for a small charge
branch-wifi: y
branch-colour-printing: available
branch-photocopying: available
branch-scan-to-email: y
branch-room-hire: /libraries/room-hire/beccles-library
branch-display-space: Noticeboard for non-commercial event posters
branch-which: y
breadcrumb: y
...
branch-other-facilities: '<ul>
                          ...
                          <li>1940s, 1950s, 1960s and 1970s memory boxes available to local borrowers for up to three weeks. Contact the library for more information.</li>
                          </ul>'
