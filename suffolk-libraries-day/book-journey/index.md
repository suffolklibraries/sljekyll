---
title: "Suffolk Libraries Day Book Journey timetable"
layout: blank
---
...
<article class="ph2 ph3-ns pv3 pv4-l bg-navy">
  ...
  <div class="bg-white b--light-gray ph2 ph3-ns pv3 pv4-ns">
    ...
    <div class="custom-max-width">
      ...
      <h1 class="f3 f2-ns custom-lh-title mb2">Suffolk Libraries Day Book Journey timetable</h1>

      <div class="measure">

        <p>In the lead-up to <a class="dark-blue underline" href="/suffolk-libraries-day/">Suffolk Libraries Day</a> (Sat 12 Oct), we’ve challenged ourselves to send a book by a local author to all 44 of our libraries, from Bungay to Haverhill.</p>

        <p>Can your organisation facilitate and sponsor a leg of the book’s journey? Contact <strong>nikki.hulse@suffolklibraries.co.uk</strong> for more information and to get involved.</p>
...
>>>>>>> working
      ...
      <div class="flex items-center">
        ...
        <table class="mw-100 mv4 overflow-x-auto v-top nowrap collapse ba b--moon-gray">
          <thead class="tl bb b--moon-gray">
            <th class="pa2">
              <strong>Route</strong>
            </th>
            <th class="pa2">
            ...
            <th class="pa2">
              <strong>Person/group and method</strong>
            </th>
          </thead>
          <tbody>
              <tr class="bg-light-gray bb b--moon-gray">
                <td class="pa2">
                  Bungay - Beccles
                </td>
                <td class="pa2">
